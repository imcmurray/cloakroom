...
<sub>The demo is a CSS-animated SVG generated by
[`scripts/gen-cli-demo.mjs`](scripts/gen-cli-demo.mjs) — reproducible from source,
like everything else here. Amber = your real data, teal = the reserved-range decoy
making the trip.</sub>
